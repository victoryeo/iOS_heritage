...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIStoryboard *countryStoryboard = [UIStoryboard storyboardWithName:@"Main" bundle:nil];
    UINavigationController *navController = [countryStoryboard instantiateInitialViewController];
    XYZHeritageTableViewController *heritageViewController = (XYZHeritageTableViewController *)navController.topViewController;
